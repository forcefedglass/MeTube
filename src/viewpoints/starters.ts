...
export function starterViewpoints(): Viewpoint[] {
  return [
    ...
    newViewpoint(
      ...
      `${STARTER_MARKER} — favors sources and topics MeTube has never shown you (strictly-unfamiliar channels, high exploration share). Demonstrates the unfamiliarity and exploration controls.`,
      NOW,
      {
